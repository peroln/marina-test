...
@section('content')
  ...
  <form action="{{ route('employee.store') }}" method="post">
    ...
    <div class="form-group">
      ...
      <input name="first_name" type="text" class="form-control" id="firstName" placeholder="first name" value="">
    </div>
    <div class="form-group">
      <label for="exampleFormControlInput1">Last name</label>
      <input name="last_name" type="text" class="form-control" id="lastName" placeholder="last name" value="">
    </div>
    <div class="form-group">
